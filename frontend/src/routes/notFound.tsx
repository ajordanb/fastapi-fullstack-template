      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
        <div className="text-center max-w-2xl mx-auto">
          <div className="mb-8 flex justify-center">
            <div className="p-6 bg-gradient-to-r from-red-500 to-orange-500 rounded-3xl shadow-2xl">
              <AlertTriangle className="w-16 h-16 text-white" />
            </div>
          </div>

          <div className="mb-6">
            <h1 className="text-8xl md:text-9xl font-bold bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent leading-none">
              404
            </h1>
          </div>
          ...
          <Card className="bg-slate-800/30 border-slate-700/50 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                ...
                >
                  <Home className="w-6 h-6 text-purple-400 mx-auto mb-2 group-hover:scale-110 transition-transform" />
                ...
                <button
                  ...
                  className="p-4 rounded-lg bg-slate-700/30 hover:bg-slate-700/50 transition-colors group"
                >
                  <LogIn className="w-6 h-6 text-green-400 mx-auto mb-2 group-hover:scale-110 transition-transform" />
                ...
                <button
                  ...
                  className="p-4 rounded-lg bg-slate-700/30 hover:bg-slate-700/50 transition-colors group"
                >
                  <AlertTriangle className="w-6 h-6 text-yellow-400 mx-auto mb-2 group-hover:scale-110 transition-transform" />
